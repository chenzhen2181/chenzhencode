...
if (inlet_test)
  %2) enter x and y coordinates of rho points
    ncellsx=552;  dx=50;  %Lm=ncellsx-2  swan=ncellsx-1
  ...
  %3) set depth 
    depth=load('N:\chenzhen\boshengliu\Visser\bath\Visser_bath_1000_10_adddepth.txt')'
  %4) set masking
    mask_rho=ones(size(depth));
  %5) enter output file name
    fname='N:\chenzhen\boshengliu\Visser\nc\Visser_bath_1000_adddepth.nc';
